...
public class Task_pol_1 {
  public static void main(String[] args) {
    ...
    shape1.draw(); // Вызов метода draw() объекта shape1 (типа Circle), будет выведено "Drawing a
                   // circle."
    shape2.draw(); // Вызов метода draw() объекта shape2 (типа Rectangle), будет выведено "Drawing
                   // a rectangle."
